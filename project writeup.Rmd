...
Now the Test set (*pml.test*, 20% of the dataset) is used to get an idea of the model's accuracy. This is shown in the confusion matrix below. It is `r format(round(cm$overall["Accuracy"]*100, 2))`% accurate.
